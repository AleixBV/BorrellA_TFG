...
public class Controls {
    ...
    public KeyCode startTheVehicleController = KeyCode.Joystick1Button6;
    ...
    public KeyCode handBrakeInputController = KeyCode.Joystick1Button3;
...
public class MSSceneController : MonoBehaviour {
    public bool show_debug_gui = false;
